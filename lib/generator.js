...
module.exports = {
  ...
  //Show
  generateClientShowHtmlFile: function(name) {
    _generate(blueprints.clientShowHtml, name);
  },
  generateClientShowJsFile: function(name) {
    _generate(blueprints.clientShowJs, name);
  },
